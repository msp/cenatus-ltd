defmodule CenatusLtdWeb.RedirectorTest do
  ...
  defmodule Router do
    ...
    get "/foo", Redirector, external: "https://foo.com"
  end
  ...
  test "route redirected to external route without query string" do
    conn = call(Router, :get, "/foo")

    assert_redirected_to(conn, "https://foo.com")
  end
